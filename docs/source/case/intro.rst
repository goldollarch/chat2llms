...
It is utterly absurd that the so-called  :doc:`evidence of criminal activity </chats/elements/actions/index>` by the police merely consists of some sporadic online posts he had shared (mostly reposted rather than original) from his `Twitter/X  accounts <https://x.com/_cenjoy>`_, which he was forced to make public after his arrest. These reposts even include content from many official accounts, such as `the following post <https://x.com/USA_China_Talk/status/1286866277101965312>`_  from `the official account <https://x.com/USA_China_Talk>`_  of the U.S. Embassy and Consulates in China, published on July 25, 2020.
