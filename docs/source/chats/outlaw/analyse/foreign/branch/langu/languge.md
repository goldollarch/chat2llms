...
* **代表人物**：[索绪尔](/chats/outlaw/analyse/foreign/branch/langu/saussure/index)（奠基人）
...
* **代表人物**：[乔姆斯基](/chats/outlaw/analyse/foreign/branch/langu/chomsky/index)
* **核心思想**：关注人类的**语言能力**。认为所有人类大脑中都先天存在一个 **“普遍语法”** ，它是一套有限的抽象规则，可以生成和理解无限多的句子。语言学的目标是描述这套内在的心理机制。
* **焦点**：高度抽象化、形式化，侧重句法的核心地位，探索语言的**心智属性**。

#### **3. 系统功能语言学（功能主义代表）**

* **代表人物**：[M.A.K. 韩礼德](/chats/outlaw/analyse/foreign/branch/langu/makhan/index)
...
* **代表人物**：[乔治·莱考夫](/chats/outlaw/analyse/foreign/branch/langu/lakoff/index)、[罗纳德·兰艾克](/chats/outlaw/analyse/foreign/branch/langu/lauck/index)。
