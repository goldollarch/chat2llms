...
好的。我将结合爱比克泰德（Epictetus，斯多亚学派后期代表）的核心思想来评析陈京元案。爱比克泰德的哲学重心在于：**区分可控与不可控（the dichotomy of control）**、**依理性而活**、**自由在于内心**、以及**正义与责任**。以下为中英文对照分析：
...
1. Courts judged with prejudice, not reason and evidence;
2. Selective enforcement violated justice;
3. Excessive punishment lacked proportion;
