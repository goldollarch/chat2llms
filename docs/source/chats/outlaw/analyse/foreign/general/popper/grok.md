...
- **Unfalsifiable Accusation**: The charge of “picking quarrels” lacks clear criteria, making it immune to refutation. No evidence was provided to show actual disruption (posts had <100 retweets, zero followers, no tangible impact), violating Popper’s requirement for testable propositions. The “pocket crime” operates like a pseudo-scientific claim, vague and unchallengeable.
...
- **Critical Refutation**: By citing data (low retweet count, zero followers) and logical limits (e.g., Gödel’s incompleteness theorem to acknowledge knowledge boundaries), Chen exposes the judiciary’s lack of evidence. His refutation of the “disorder” claim mirrors Popper’s insistence on falsifying weak theories.
